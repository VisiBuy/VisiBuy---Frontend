			...
			<div className="pp-container">
                ...
                <div className="pp-description">
					...
					<p className="pp-description-text">
						...
						beta program. Transaction Information: Details about your purchases,
						including the products you order, payment information, and order
						...
						to collect data about your activity within the platform. These tools
						help us analyze performance and improve your user experience. You
						may control cookie settings through your browser.</p></div> <div><span className="pp-number">2.</span> <p>How We Use Your
						Information We use the collected information for the following
						purposes: Platform Testing and Improvement: Identifying bugs,
						optimizing performance, and improving the platform experience based
						on user feedback and behavior. User Communication: Sending updates,
						notifications, and marketing communications related to the beta
						program, new features, or feedback requests. Analytics: Analyzing
						usage data to understand patterns and make data-driven decisions for
						platform enhancements. Security: Protecting against unauthorized
						access, fraud, and ensuring the integrity of our services.</p></div> <div><span className="pp-number">3.</span>
						<p>Information Sharing We do not sell or rent your personal information
						to third parties. However, we may share your information with
						trusted third-party service providers for specific purposes,
						including: Cloud Hosting: Storing data securely using cloud
						providers. Payment Processing: Managing payment transactions through
						secure third-party providers. Analytics and Marketing Tools:
						Utilizing third-party tools to analyze platform performance and run
						marketing campaigns.</p></div> <div><span className="pp-number">4.</span> <p>Data Retention We will retain your personal
						information for the duration of the beta program. Once the program
						concludes, your data will either be securely deleted or anonymized
						unless required to retain it for legal obligations. 5. Security of
						Your Information We take reasonable and industry-standard measures
						to protect your personal information from unauthorized access,
						disclosure, or misuse. We use encryption technologies, including
						...
						Protection Rights As a beta user, you have the following rights
						concerning your personal information: Access: You may request access
						to the personal data we hold about you. Correction: You have the
						right to request corrections to inaccurate or incomplete personal
						...
						of the updated policy.</p></div> <div><span className="pp-number">10.</span> <p>Contact Us If you have any questions or
						concerns about this Privacy Policy or your data, feel free to
						contact us at: Email: tech@visibuy.com.ng</p></div>
					</p>
				</div>
			</div>
		</section>
